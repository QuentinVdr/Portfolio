...
const Details = ({ position, company, companyLink, time, address, work, report }) => {
        ...
        <div id="experience-section" className="my-64">
            ...
            />
                <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
                    <Details
                      position="Stagiaire, Developpeur FullStack"
                      company="Infotel"
                      ...
                      interactive qui permet de visualiser les clients de maniere géographique. J'ai aussi mis à
                      jours les formulaire d'ajout de client pour rendre la saisie de la possition facile et j'ai
                    ...
                    <Details
                        position="Stagiaire, Developpeur Back-End"
                        company="MyMoneyBank"
                        ...
                        j'ai fait beaucoup de Maintenance sur les APIs du service. J'ai créer de la documentaitons pour
                    ...
                    <Details
                        ...
                        time="mai 2022"
                        address="44300 Nantes"
                        work="Durant ce stage j'ai découver la vie d'entreprise et les API en language JAVA. J'ai
                        ...
                        qui empeche l'insertion en base de données."
