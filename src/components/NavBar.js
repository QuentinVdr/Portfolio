...
const NavBar = () => {
    ...
    return (
        <header
            className="w-full px-32 2xl:px-12 py-8 font-medium flex items-center justify-between
        ...
        >
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                <nav className="flex items-center justify-center gap-8">
                    ...
                    <CustomLink href="/BTS" title="BTS SIO" />
                </nav>
                ...
                >
                    ...
                    <nav className="flex items-center justify-center flex-wrap mt-2">
                        <motion.a
                            href="mailto:quent1.verdier@gmail.com"
                            target={"_blank"}
                            className="w-6 mx-3 bg-light rounded-md dark:bg-dark sm:mx-1"
                            whileHover={{ y: -2 }}
                            whileTap={{ scale: 0.9 }}
                        >
                            <MailIcon />
